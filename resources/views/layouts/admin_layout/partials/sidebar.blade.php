    ...
    <div class="sidebar-wrapper active">
        <div class="sidebar-header position-relative">
            <div class="d-flex justify-content-between align-items-center">
                <div class="logo">
                    <a href="index.html">
                        <img src="{{ asset('static/img/iconmedia.png') }}" alt="Logo" style="height: 60px; width: 120px">
                    </a>
                </div>
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li class="sidebar-item has-sub {{ request()->is('karyawan') || request()->is('karyawan/*') || request()->is('jabatan') || request()->is('jabatan/*') || request()->is('divisi') || request()->is('divisi/*') || request()->is('shifts') || request()->is('shifts/*') ? 'active' : '' }}">
                    ...
                    <ul class="submenu ">
                        ...
                        <li class="submenu-item  {{ request()->is('karyawan') || request()->is('karyawan/*') ? 'active' : '' }}">
                            <a href="{{ route('karyawan.index') }}" class="submenu-link">Data Karyawan</a>

                        </li>

                        <li class="submenu-item {{ request()->is('divisi') || request()->is('divisi/*') ? 'active' : '' }}">
                            <a href="{{ route('divisi.index') }}" class="submenu-link">Divisi</a>

                        </li>
                        <li class="submenu-item {{ request()->is('jabatan') || request()->is('jabatan/*') ? 'active' : '' }} ">
                            <a href="{{ route('jabatan.index') }}" class="submenu-link">Jabatan</a>

                        </li>
                        <li class="submenu-item {{ request()->is('shifts') || request()->is('shifts/*') ? 'active' : '' }}">
                            <a href="{{ route('shifts.index') }}" class="submenu-link">Shift & Jam Kerja</a>
                ...
                <li class="sidebar-item  has-sub">
                    ...
                    <ul class="submenu ">
                        ...
                        <li class="submenu-item  ">
                            <a href="component-alert.html" class="submenu-link">Pengaturan</a>

                        </li>

                        <li class="submenu-item  ">
                            <a href="component-alert.html" class="submenu-link">Tugas Otomatis</a>

                        </li>

                        <li class="submenu-item  ">
                            <a href="component-alert.html" class="submenu-link">Integrasi WA Gateway</a>
                ...
                <li class="sidebar-item  has-sub">
                    ...
                    <ul class="submenu ">
                        ...
                        <li class="submenu-item  ">
                            <a href="component-accordion.html" class="submenu-link">Informasi Profil</a>

                        </li>

                        <li class="submenu-item  ">
                            <a href="component-alert.html" class="submenu-link">Kata Sandi & Keamanan</a>
