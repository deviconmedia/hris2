...
<body>
    ...
    <div class="preloader">
        <div class="preloader-container">
            <img src="{{ asset('mazer/assets/compiled/svg/audio.svg') }}" alt="image loader" class="rounded-circle">
    ...
    <div id="app">
        @include('layouts.admin_layout.partials.sidebar')
        <div id="main">
            <header class="mb-3">
            ...
            <div class="page-heading">
                @include('layouts.admin_layout.partials.page_heading')
            ...
            @include('layouts.admin_layout.partials.footer')
        </div>
    </div>

    {{-- Logout Modal --}}
    <div class="modal fade text-left" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel120"
        aria-hidden="true">
