        ...
        <div class="card">
            <div class="card-header">
                <div class="card-header-action d-flex justify-content-end">
                    <a href="{{ route('divisi.create') }}" class="btn btn-primary rounded-pill"><i class="bi bi-plus-lg"></i>
                        Tambah Baru</a>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table" id="divisiTable">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>Nama Divisi</th>
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            if (response.success) {
                                ...
                                $('#divisiTable').DataTable().ajax.reload(); // Reload tabel DataTables
                            } else {
